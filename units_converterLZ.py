...
while True:
    ...
    if i_convention.upper() == "C":
        ...
        print("please note that you can 123123 this app by 'exit' command at the next input\n")
    elif i_convention.upper() == "F":
        degree = int(x[:-1])
        result = int(round((degree - 32) * 5 / 9))
        edin_izmer = "Celsius"
        print("\n The temperature in", edin_izmer, "is", result, "degrees.")
        print("please note that you can leave123123123 this app by 'exit' at the next input\n")
    elif x == "exit":
        break
    else:
