...
# start
# 3. tail - display last 10 lines of the file | -n x / -x to specify number of lines
...
def main():
    parser = argparse.ArgumentParser(description="Displays last 10 lines in files if not specified")
